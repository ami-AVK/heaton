...
import { A as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, h as UnsupportedImageConversion, N as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, i as ExpectedImageOptions, j as ExpectedNotESMImage, k as InvalidImageService, t as toStyleString, d as createAstro, c as createComponent, l as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, a as addAttribute, s as spreadAttributes, e as renderComponent } from './astro/server_-1qDrZfG.mjs';
import * as mime from 'mrmime';
/* empty css                         */
import 'clsx';
import 'kleur/colors';
import { L as Logo, d as LogoSmall, $ as $$Icon } from './ClientRouter_JO4vnJ_i.mjs';
...
const baseService = {
  ...
  getURL(options, imageConfig) {
    ...
    const imageEndpoint = joinPaths("/heaton", imageConfig.endpoint.route);
...
}, "/Users/santech/Documents/My/WebProjects/Heaton/heaton_/heaton/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/santech/Documents/My/WebProjects/Heaton/heaton_/heaton/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"endpoint":{"route":"/_image"},"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[],"experimentalResponsiveImages":true};
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="bg-stone-600"> <div class="w-full max-w-5xl mx-auto p-4 md:py-8"> <div class="sm:flex sm:items-center sm:justify-between"> <div class="flex items-center gap-4"> <a href="/"${addAttribute(`cursor-pointer text-[#FCD47F] ${mainpage ? "pointer-events-none" : ""}`, "class")}> ${renderComponent($$result, "Logo", Logo, { "class": "w-20 md:w-32 lg:w-40 hidden md:block" })} ${renderComponent($$result, "LogoSmall", LogoSmall, { "class": "w-16 md:hidden" })} </a> <div class="flex flex-col gap-2"> <div class="flex gap-2 items-center text-stone-400"> ${renderComponent($$result, "Icon", $$Icon, { "name": "Phone call" })} <div class="text-base leading-5 font-semibold relative  tracking-wider">8 499 645-00-00</div> </div> <div class="flex gap-2 items-center text-stone-400"> ${renderComponent($$result, "Icon", $$Icon, { "name": "At sign" })} <div class="text-base leading-5 font-semibold relative  tracking-wider">retail@heaton.ru</div> </div> </div> </div> <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-stone-400 sm:mb-0 "> ${links.map((link, index) => renderTemplate`<li${addAttribute(index, "key")}> <a${addAttribute(link.href, "href")} class="hover:underline me-4 md:me-6">${link.text}</a> </li>`)} </ul> </div> <hr class="my-6 sm:mx-auto border-stone-700 lg:my-8"> <span class="block text-sm  sm:text-center text-stone-400"> ${copyrightText} <a${addAttribute(copyrightLink.href, "href")} class="hover:underline">${copyrightLink.text}</a> </span> </div> </footer>`;
}, "/Users/santech/Documents/My/WebProjects/Heaton/heaton_/heaton/src/components/Footer.astro", void 0);

export { $$Image as $, $$Footer as a, baseService as b, parseQuality as p };
