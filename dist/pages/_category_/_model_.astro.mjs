...
<br>Выпускаемые длины: 400-3000 мм (с шагом 100 мм) <br>Гарантия 10 лет
  ...
  ))} </ul> <div class=""${addAttribute(renderTransition($$result, "vhmklkpi"), "data-astro-transition-scope")}>${renderComponent($$result, "Table", $$Table, { "csvData": csvData })}</div> </div> </body></html>`;
}, "/Users/santech/Documents/My/WebProjects/Heaton/heaton_/heaton/src/pages/[category]/[model].astro", "self");

const $$file = "/Users/santech/Documents/My/WebProjects/Heaton/heaton_/heaton/src/pages/[category]/[model].astro";
const $$url = "/heaton/[category]/[model]";
